...
;	main.c:61: g_word_size = get_word_length(g_parts_count, word_parts);
	...
	mov	(_get_word_length_PARM_2 + 1),#(_word_parts >> 8)
	mov	(_get_word_length_PARM_2 + 2),#0x80
...
;	main.c:89: P2 = ~(get_word_value((g_cursor-g_delta_pos), g_word_size, g_parts_count, word_parts));
	...
	mov	(_get_word_value_PARM_4 + 1),#(_word_parts >> 8)
	mov	(_get_word_value_PARM_4 + 2),#0x80
...
_font_space:
	...
	.db #0x00	; 0
_word_parts:
	.byte _font_M, (_font_M >> 8),#0x80
	.byte #0x09, #0x00	;  9
	.byte _font_I, (_font_I >> 8),#0x80
	.byte #0x08, #0x00	;  8
	.byte _font_C, (_font_C >> 8),#0x80
	.byte #0x08, #0x00	;  8
	.byte _font_H, (_font_H >> 8),#0x80
	.byte #0x07, #0x00	;  7
	.byte _font_E, (_font_E >> 8),#0x80
	.byte #0x08, #0x00	;  8
	.byte _font_L, (_font_L >> 8),#0x80
	.byte #0x07, #0x00	;  7
	.byte _font_L, (_font_L >> 8),#0x80
	.byte #0x07, #0x00	;  7
	.byte _font_E, (_font_E >> 8),#0x80
	.byte #0x08, #0x00	;  8
	.byte _font_space, (_font_space >> 8),#0x80
	.byte #0x03, #0x00	;  3
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
